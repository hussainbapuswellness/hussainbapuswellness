document.addEventListener("DOMContentLoaded", function () {
    ...
    console.log("🌐 HBW Language System Started");
    ...
    function setText(id, value, useHTML = false) {
        ...
        if (!element) {
            console.warn("⚠️ Missing HTML ID:", id);
            return;
        }

        if (value === undefined || value === null) {
            console.warn("⚠️ Missing translation:", id);
            return;
        }
    ...
    function applyLanguage(lang) {
        ...
        if (typeof translations === "undefined") {
            ...
            console.error(
                "❌ translations.js is NOT loaded or contains an error."
            );

            alert(
                "Translation system error: translations.js is not loading."
            );
        ...
        // STATS
        // --------------------------------------------------
   setText("stadocument.addEventListener("DOMContentLoaded", function () {
